...
var ParsedError, PrettyError, array, defaultStyle, instance, nodePaths, object, prop, treeify, _fn, _i, _len, _ref, _ref1,
  __slice = [].slice,
...
module.exports = PrettyError = (function() {
  ...
  PrettyError.prototype.render = function(e, logIt, useColors) {
    ...
    rendered = this._renderer(obj, useColors);
    if (logIt === true) {
